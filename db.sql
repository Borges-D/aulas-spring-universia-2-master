...
INSERT INTO filmes (titulo, descricao, estudio, classificacao)
VALUES 
  ...
  ('Efeito Borboleta', 'Viagem no tempo e suas consequências', 'New Line Cinema', 6),
  ('O Poderoso Chefão', 'Um épico de Francis Ford Coppola', 'Paramount Pictures', 9);
